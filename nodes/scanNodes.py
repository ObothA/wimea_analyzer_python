...
def scanNodes(stationsIDs):
  ...
  for sID in stationsIDs:
    ...
    for table in list_of_tables:
      ...
      if len(latest_secondsEpoch) == 19 and type(latest_secondsEpoch) is not None and len(second_latest_secondsEpoch) == 19 and type(second_latest_secondsEpoch) is not None:
